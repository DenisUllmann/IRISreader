...
"""
aia_cube class: abstraction that makes the data, the headers and a number
of auxiliary variables available for SDO AIA image data
"""
...
from irisreader import sdo_data_cube
from irisreader.utils.notebooks import in_notebook

class aia_cube( sdo_data_cube ):
    """
    This class implements an abstraction of an SDO AIA FITS file.
    
    Parameters
    ----------
    file : string
        Path to the SDO AIA FITS file.
    keep_null : boolean
    ...
    n_files : int
        Number of FITS files (always =1 for SJI or AIA)
...
if __name__ == "__main__":
    ...
    aia = aia_cube( 'C:/Users/Denis/Documents/IRIS/IRIS_SDO_modalities/2014/10/30/aia_l2_20141030_050004_3893010094_94' )
#    very_large_aia = aia_cube( "/home/chuwyler/Desktop/FITS/20140420_223915_3864255603/iris_l2_20140420_223915_3864255603_SJI_1400_t000.fits" )
